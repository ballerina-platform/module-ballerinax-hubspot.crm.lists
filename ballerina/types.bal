...
# Represents the Queries record for the operation: put-/crm/v3/lists/{listId}/update-list-filters_updateListFilters
public type PutCrmV3ListsListidUpdateListFilters_updatelistfiltersQueries record {
...
# Represents the Queries record for the operation: get-/crm/v3/lists/{listId}/memberships/join-order_getPageOrderedByAddedToListDate
public type GetCrmV3ListsListidMembershipsJoinOrder_getpageorderedbyaddedtolistdateQueries record {
...
# Represents the Queries record for the operation: get-/crm/v3/lists/object-type-id/{objectTypeId}/name/{listName}_getByName
public type GetCrmV3ListsObjectTypeIdObjecttypeidNameListname_getbynameQueries record {
...
# Represents the Queries record for the operation: put-/crm/v3/lists/{listId}/update-list-name_updateName
public type PutCrmV3ListsListidUpdateListName_updatenameQueries record {
...
# Represents the Queries record for the operation: get-/crm/v3/lists/idmapping_translateLegacyListIdToListId
public type GetCrmV3ListsIdmapping_translatelegacylistidtolistidQueries record {
...
# Represents the Queries record for the operation: get-/crm/v3/lists/{listId}/memberships_getPage
public type GetCrmV3ListsListidMemberships_getpageQueries record {
    # The paging offset token for the page that comes `before` the previously requested records.
    # 
    # If provided, then the records in the response will be the records preceding the offset, sorted in *descending* order.
    string before?;
...
# Represents the Queries record for the operation: put-/crm/v3/lists/folders/{folderId}/rename_rename
public type PutCrmV3ListsFoldersFolderidRename_renameQueries record {
    # 
...
# Represents the Queries record for the operation: get-/crm/v3/lists/{listId}_getById
public type GetCrmV3ListsListid_getbyidQueries record {
    # A flag indicating whether or not the response object list definition should include a filter branch definition. By default, object list definitions will not have their filter branch definitions included in the response.
    boolean includeFilters = false;
};
...
# Represents the Queries record for the operation: get-/crm/v3/lists/folders_getAll
public type GetCrmV3ListsFolders_getallQueries record {
...
# Represents the Queries record for the operation: get-/crm/v3/lists/_getAll
public type GetCrmV3Lists_getallQueries record {
