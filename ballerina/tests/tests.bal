...
function testCreateADynamicList() returns error? {
    ...
    includeObjectsWithNoValueSet: false, values: ["John"], operationType: "MULTISTRING", operator: "IS_EQUAL_TO"
    };
    PublicPropertyFilter filterName = {
        property: "firstname", filterType: "PROPERTY", operation: {...operation}
    };
    PublicAndFilterBranch nestedFilterBranch = {
    filterBranchType: "AND", filterBranches: [], filterBranchOperator: "AND", filters: [filterName]
    };
    PublicOrFilterBranch filterBranch = {
    filterBranchType: "OR", filterBranches: [nestedFilterBranch], filterBranchOperator: "OR", filters: []
    };
    ListCreateRequest payload = {
        objectTypeId: "0-1",
...
function testUpdateListFilter() returns error? {
    ...
    includeObjectsWithNoValueSet: false, values: ["Doe"], operationType: "MULTISTRING", operator: "IS_EQUAL_TO"
    };
    PublicPropertyFilter filterFirstName = {
        property: "firstname", filterType: "PROPERTY", operation: {...operationFirstname}
    };
    PublicPropertyFilter filterLastName = {
        property: "firstname", filterType: "PROPERTY", operation: {...operationLastname}
    };
    PublicAndFilterBranch nestedFilterBranch = {
    filterBranchType: "AND", filterBranches: [], filterBranchOperator: "AND", filters: [filterFirstName, filterLastName]
    };
    PublicOrFilterBranch filterBranch = {
    filterBranchType: "OR", filterBranches: [nestedFilterBranch], filterBranchOperator: "OR", filters: []
    };
